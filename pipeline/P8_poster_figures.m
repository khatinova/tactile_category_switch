...
%            -> FRN/FCz negativity, P300, frontal theta by block type x outcome
...
EEG_MEASURES = {
    'FCz_neg_peak_norm', 'FCz negativity (FRN)',        -1
...
if ismember('confidence', gt.Properties.VariableNames) && ...
   ismember('FCz_neg_peak_norm_z', gt.Properties.VariableNames)
    ...
    fprintf('P8.5a skipped: need confidence + FCz_neg_peak_norm_z.\n');
end
