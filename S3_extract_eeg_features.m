...
% 
% % load('\\humerus\pharm_banerjee\data\Projects\EEG_projects\Salient_Modality_Switch\Salient mod switch KH\Results\EEG analysis\Outcome_feature_tables_v4_merged\group_feature_table_combined_KH.mat');
% 
...
% 
% save(fullfile(save_folder,'group_stage_table_features.mat'), 'group_table', 't_global');
% save(fullfile(save_folder,'frn_rewp_by_stage.mat'), 'frn_rewp_stage_table');
% fprintf('Saved group_stage_table_features.mat + frn_rewp_by_stage.mat\n');
