% ==========================================================================
% S6_behaviour_plots_stats.m
%
% PIPELINE STEP 6 — behavioural stage figures, statistics, and
% sequential-block learning analyses.
%
% Canonical version: consolidated from S6, S6_v2, S6_flexible_stagewin,
% and S6c_sequential. Supersedes all of those files.
%
% Key settings at the top of the script:
%   STAGE_WIN              — stage window width (trials); default 15
%   STAGE_ASSIGNMENT_POLICY — 'protect_edges' keeps LN/RE at full width
